...
- 🌱 I work mostly with Swift, UIKit, SwiftUI and Python. I have experience building cross-platform mobile products using Flutter, Dart and a bit of ionic. I have built awesome products and can work in a cross-functional team. I am well versed in web development tools like HTLM, CSS, Javascript, Bootstrap and MongoDB. I am also a cloud engineer specializing in AWS Cloud Computing. Github serves as a host for the professional projects I've worked on as well as fun projects I'll be handling in order to master new concepts and frameworks.
<br/>
